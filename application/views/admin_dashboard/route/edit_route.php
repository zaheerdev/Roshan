			...
			<div class="row">
				...
				<div class="col-lg-12">
					...
					<div class="card card-primary">
						...
						<!-- /.card-header -->
						<!-- form start -->
						<form class="p-4" action="<?= BASE_URL . "routes/update_route/$route->id" ?>" method="post">
							<div class="form-group w-sm-100 w-lg-50">
								<label for="">Route Name</label>
								<input type="text" name="name" value="<?= $route->route ?>" class="form-control" placeholder="Route Name">
