            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <a href="<?= BASE_URL ?>inventory/add_product_inventory" class="btn btn-primary">Product Inventory</a>
                            <a href="<?= BASE_URL ?>inventory/add_raw_inventory" class="btn btn-primary">Raw Materials</a>
                        </div>
