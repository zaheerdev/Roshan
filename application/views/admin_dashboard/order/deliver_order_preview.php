...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Preview Deliver Order</h1>
                </div>
                <div class="col-sm-6">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <p>Discount: <?= $order_details[0]->discount ?></p>
                                    <p>Net Total: <?= $order_details[0]->net_total ?></p>
                                    <p>Paid Amount: <?= $order_details[0]->paid_amount ?></p>
                                    <?php if($order_details[0]->due_amount > 0):?>
                                        <p>Due Amount: <?= $order_details[0]->due_amount ?></p>
                                    <?php endif;?>
                                </div>
                            </div>

                            <div class="row">
                                <a href="<?= BASE_URL ?>order/deliver_order_pdf/<?= $order_details[0]->order_id; ?>" class="btn btn-success mt-4">Share via Whatsapp</a>
                            </div>
